...
@dataclass
class DatasetPaths:
    train_image_dir: str = r"\data\ljc\datasets\coco2017\train\images"
    val_image_dir: str = r"\data\ljc\datasets\coco2017\valid\images"
    train_coco_json: str = r"\data\ljc\datasets\coco2017\train\_annotations.coco_neg.json"
    val_coco_json: str = r"\data\ljc\datasets\coco2017\valid\_annotations.coco.json"
